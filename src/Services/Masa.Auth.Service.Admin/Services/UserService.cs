...
namespace Masa.Auth.Service.Admin.Services
{
    public class UserService : RestServiceBase
    {
        ...
        private async Task Visited(IEventBus eventBus, [FromBody] AddUserVisitedDto addUserVisitedDto)
        {
        ...
        private async Task<List<UserVisitedDto>> VisitList(IEventBus eventBus, [FromQuery] Guid userId)
        {
