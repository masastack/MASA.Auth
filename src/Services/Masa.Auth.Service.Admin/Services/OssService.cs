...
public class OssService : RestServiceBase
{
    ...
    {
        var ossOptions = masaConfiguration.ConfigurationApi.GetPublic().GetSection(OssOptions.Key).Get<OssOptions>();
        MasaArgumentException.ThrowIfNull(ossOptions, nameof(OssOptions));
