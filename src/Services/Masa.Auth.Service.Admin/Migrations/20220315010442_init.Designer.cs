...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Permissions.Aggregates.PermissionRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Permissions.Aggregates.RoleRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiResourceClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiResourceProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiResourceScope", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiResourceSecret", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiScope", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiScopeClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiScopeProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ClientGrantType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ClientRedirectUri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ClientSecret", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.DeviceFlowCodes", b =>
                {
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.IdentityResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.IdentityResourceClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.IdentityResourceProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.PersistedGrant", b =>
                {
                    b.Property<string>("Key")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Subjects.Aggregates.ThirdPartyIdp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiResourceClaim", b =>
                {
                    b.HasOne("Masa.Auth.Service.Domain.Sso.Aggregates.ApiResource", "ApiResource")
                        .WithMany("UserClaims")
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ApiScopeClaim", b =>
                {
                    b.HasOne("Masa.Auth.Service.Domain.Sso.Aggregates.ApiScope", "Scope")
                        .WithMany("UserClaims")
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.ClientGrantType", b =>
                {
                    b.HasOne("Masa.Auth.Service.Domain.Sso.Aggregates.Client", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Sso.Aggregates.IdentityResourceClaim", b =>
                {
                    b.HasOne("Masa.Auth.Service.Domain.Sso.Aggregates.IdentityResource", "IdentityResource")
                        .WithMany("UserClaims")
            ...
            modelBuilder.Entity("Masa.Auth.Service.Domain.Subjects.Aggregates.Staff", b =>
                {
                    b.HasOne("Masa.Auth.Service.Domain.Organizations.Aggregates.Position", "Position")
                        .WithOne()
                        .HasForeignKey("Masa.Auth.Service.Domain.Subjects.Aggregates.Staff", "PositionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
