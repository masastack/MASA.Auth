...
namespace Masa.Contrib.Authentication.OpenIdConnect.EFCore.Caches
{
    public class SyncCache2
    {
        ...
        public SyncCache2(IClientCache clientCache, IApiResourceCache apiResourceCache, IApiScopeCache apiScopeCache, IIdentityResourceCache identityResourceCache, OidcDbContext context)
        {
