...
public class UpdateStaffDto
{
    ...
    public AddOrUpdatePositionDto Position { get; set; }
    ...
    public UpdateStaffDto(Guid id, string jobNumber, StaffTypes staffType, bool enabled, Guid departmentId, AddOrUpdatePositionDto position, List<Guid> teamIds, UpdateUserDto user)
    {
        Id = id;
        JobNumber = jobNumber;
        StaffType = staffType;
