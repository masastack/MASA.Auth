...
public class RoleDetailDto : RoleDto
{
    ...
    public RoleDetailDto(Guid id, string name, string description, bool enabled, int limit, List<Guid> permissions, List<Guid> parentRoles, List<Guid> childrenRoles, List<UserSelectDto> users, List<Guid> teams, DateTime creationTime, DateTime? modificationTime, string creator, string modifier, int quantityAvailable) : base(id, name, limit, description, enabled, creationTime, modificationTime, creator, modifier)
    {
