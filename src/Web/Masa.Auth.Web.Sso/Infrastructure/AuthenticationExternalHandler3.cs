...
public class AuthenticationExternalHandler3 : IAuthenticationExternalHandler
{
    ...
    public AuthenticationExternalHandler3(IAuthClient authClient, IIdentityServerInteractionService interaction, IEventService events, IHttpContextAccessor contextAccessor)
    {
    ...
    public async Task<bool> OnHandleAuthenticateAfterAsync(AuthenticateResult result)
    {
        ...
        isuser.AdditionalClaims.Add(new Claim("role", JsonSerializer.Serialize(userModel.Roles.Select(role => role.Code))));
