...
public class WeixinBuilder : ILocalAuthenticationDefaultBuilder, IAuthenticationInject, IAuthenticationInstanceBuilder
{
    public string Scheme => WeixinAuthenticationDefaults.AuthenticationScheme;
    ...
    public AuthenticationDefaults AuthenticationDefaults => new AuthenticationDefaults
    {
        ...
        Icon = "https://cdn.masastack.com/stack/auth/ico/weixin.svg",
        ...
        ThirdPartyIdpType = ThirdPartyIdpTypes.Weixin,
