...
using Masa.Auth.Web.Admin.Rcl.Data.App.User.Dto;
using Masa.Auth.Web.Admin.Rcl.Pages.App.User.ViewModel;

namespace Masa.Auth.Web.Admin.Rcl.Pages.App.User
{
    public partial class List
    {
        public bool _visible;
        public UserPage _userPage = new(Data.App.User.UserService.GetList());
        ...
        private readonly Dictionary<string, string> _roleIconMap = Data.App.User.UserService.GetRoleIconMap();
