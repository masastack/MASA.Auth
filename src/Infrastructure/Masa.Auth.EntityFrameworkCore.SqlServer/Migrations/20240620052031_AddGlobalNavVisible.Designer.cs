...
namespace Masa.Auth.Service.Admin.Migrations
{
    ...
    [Migration("20240620052031_AddGlobalNavVisible")]
    partial class AddGlobalNavVisible
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Masa.Auth.Service.Admin.Domain.GlobalNavs.Aggregates.GlobalNavVisible", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Masa.Auth.Service.Admin.Domain.Subjects.Aggregates.UserClaimValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Admin.Domain.Webhooks.Aggregates.Webhook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Admin.Domain.Webhooks.Aggregates.WebhookLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Masa.Auth.Service.Admin.Domain.Permissions.Aggregates.Permission", b =>
                {
                    b.HasOne("Masa.Auth.Service.Admin.Domain.Permissions.Aggregates.Permission", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Masa.Auth.Service.Admin.Domain.Permissions.Aggregates.PermissionRelation", b =>
                {
                    b.HasOne("Masa.Auth.Service.Admin.Domain.Permissions.Aggregates.Permission", "AffiliationPermission")
                        .WithMany("LeadingPermissionRelations")
                        .HasForeignKey("AffiliationPermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Masa.Auth.Service.Admin.Domain.Permissions.Aggregates.Permission", "LeadingPermission")
            ...
            modelBuilder.Entity("Masa.Auth.Service.Admin.Domain.Webhooks.Aggregates.WebhookLog", b =>
                {
                    b.HasOne("Masa.Auth.Service.Admin.Domain.Webhooks.Aggregates.Webhook", "Webhook")
